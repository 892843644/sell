        ...
        <div id="page-content-wrapper">
            <div class="container-fluid">
                <div class="row clearflx">
                    ...
                    <#list productInfoEntityPage.records as productInfo>
                    <tr>
                ...
                <#--分页-->
                    ...
                    <#else>
                        <li><a href="/sell/seller/product/list?page=${productInfoEntityPage.current-1}&size=${size}">上一页</a></li>
                    </#if>
                    ...
                    <#else>
                     <li><a href="/sell/seller/product/list?page=${productInfoEntityPage.current+1}">下一页</a></li>
                    </#if>
                        </ul>
                    </div>
                </div>
